        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible;animation-delay: 0.2s;animation-name: fadeInUp;margin-inline-end: -365px;margin-left: 283px;">
                            <form action="/ContactusData">
                                <div class="row g-3">
                                    <div class="col-md-6">
